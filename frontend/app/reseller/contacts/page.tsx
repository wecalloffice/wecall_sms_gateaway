...
export default function ResellerContactsPage() {
  const [contacts, setContacts] = useState([
    { id: 1, name: 'John Doe', phone: '+254712345678', email: 'john@kcb.com', group: 'Marketing', added: '2024-01-15' },
    { id: 2, name: 'Jane Smith', phone: '+254723456789', email: 'jane@kcb.com', group: 'Sales', added: '2024-01-16' },
    { id: 3, name: 'Bob Johnson', phone: '+254734567890', email: 'bob@kcb.com', group: 'Support', added: '2024-01-17' },
  ]);
