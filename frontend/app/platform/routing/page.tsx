...
import { Route, GitBranch, Activity, Zap } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Configure routing rules and gateways</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Failover Routes</p>
                  ...
                  <tr key={route.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        route.successRate >= 98 ? 'bg-green-100 text-green-800' :
                        route.successRate >= 95 ? 'bg-yellow-100 text-yellow-800' :
