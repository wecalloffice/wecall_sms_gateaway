...
export function ResellerRegistrationModal({ isOpen, onClose, parentUsername }: ResellerRegistrationModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b sticky top-0 bg-white">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Register Sub-Reseller</h2>
            <p className="text-xs text-gray-600 mt-1">Under your reseller account</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-green-900">Reseller registered successfully!</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex gap-3 pt-6 border-t">
              ...
              >
                {loading ? "Registering..." : "Register Reseller"}
              </button>
            </div>
          </form>
        </div>
